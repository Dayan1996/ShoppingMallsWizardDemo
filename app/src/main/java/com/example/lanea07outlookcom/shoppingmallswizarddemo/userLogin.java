...
public class userLogin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        crearCuenta = findViewById(R.id.tvwCrearCuenta);
        crearCuenta.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(userLogin.this, crearUsuario.class);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(userLogin.this,Demo.class);
                startActivity(intent);
                finish();
            } else {
